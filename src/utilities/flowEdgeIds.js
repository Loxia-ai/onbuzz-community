 ...
 *
 * ReactFlow REQUIRES every edge to carry a unique `id`. Templates and
 * marketplace-installed flows ship without ids — they're a v2 schema
 * concern, not a renderer concern — so freshly-loaded flows render
 * with NO arrows between their nodes until something stamps ids.
 *
 ...
 *
 * Both layers use this same helper so the id format stays in sync.
 */
