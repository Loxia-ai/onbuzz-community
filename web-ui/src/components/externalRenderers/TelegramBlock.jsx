/**
 * TelegramBlock — renders one <external to="telegram[:…]"> block styled
 * to approximate Telegram's outbound bubble.
 */
...
const TELEGRAM_ACCENT = 'bg-[#229ED9]';
...
function TelegramBlock({ label, text, streaming = false }) {
  return (
    <ExternalCard
      icon={<TelegramIcon />}
      accentClass={TELEGRAM_ACCENT}
      bodyClass="bg-[#EFF7FC] dark:bg-[#17212B] text-gray-900 dark:text-[#E6EEF5] [&_a]:text-[#168ACD]"
      label={label}
      streaming={streaming}
    >
      {text
